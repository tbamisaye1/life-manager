...
> **Privacy / isolation:** everything runs locally. The database is a single
> SQLite file at `server/db/life-manager.sqlite`. **No cloud, no AWS** — nothing
> here can touch any other project or production system.
